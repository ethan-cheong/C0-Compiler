...
let rec build_new_function orig_stmt =
  Ast.(
    ...
    | Annotated_stm _ -> failwith "don't call tailrec on anno please")
;;
...
let update_tail_rec program_block =
  ...
  Ast.(
    ...
    | Function_Def_Anno _ -> failwith "don't call tailrec on fn_def_anno please")
;;
...
let update_all_calls program_block =
  ...
  Ast.(
    ...
    | Function_Def_Anno _ -> failwith "don't call tailrec on anno please")
;;
