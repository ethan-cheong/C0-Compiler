...
(* val instr_to_ssa : instr -> Ssa.instr
val instr_of_ssa : Ssa.instr -> instr
val body_to_ssa : body -> Ssa.body
val body_of_ssa : Ssa.body -> body
val signature_to_ssa : signature -> Ssa.header *)
